...
def draw():
    ...
    # for its X position. Pick a y value that places it half way down the
    # window.

    # 3. Fill in the ellipse with a nice color. Remember to put it above the code
    # where you draw the ellipse.

    # 4. If the mouse is pressed change the x value so that the dot moves to
    # the right
